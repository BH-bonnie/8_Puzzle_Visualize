...
from .sensor_based import  no_observation_belief_state_search, partially_observable_search
...
ALGORITHM_CATEGORIES = {
    ...
    "Sensor-Based": [ "No-Observation Belief State Search", "Partially Observable Search"],
