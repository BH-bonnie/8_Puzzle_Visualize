...
from .sensor_based import sensor_search, belief_state_search, no_observation_belief_state_search, partially_observable_search
...
ALGORITHM_CATEGORIES = {
    ...
    "Sensor-Based": ["Sensor Search", "Belief State Search", "No-Observation Belief State Search", "Partially Observable Search"],
